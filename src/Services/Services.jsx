...
export default function Services() {
    return (
        <div className="py-8" href="#services">
            ...
            <div className={"lg:grid lg:grid-cols-3 justify-center"}>
                ...
                description="Création de templates pour différents réseaux sociaux (Instagram, Facebook, Linkedin) afin de vous aider à renforcer votre présence en ligne et promouvoir votre marque auprès d'un public plus large.  Ces templates peuvent inclure des graphiques, des visuels, des infographies et des éléments interactifs attirant l'attention des utilisateurs et les encourageant à interagir avec la marque." />
            </div>
        </div>
    )
}